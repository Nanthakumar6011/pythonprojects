...
# st.set_page_config(page_title="simple finaance app",page_icon="$$",layout="wide")
...
# def categorized_transaction():
#     df["Category"]="Uncategorized"

#     for category,keywords in st.session_state.categories.items():
#         if category == 'Uncategorized' or not keyword:
#             continue
...
#         df=load_transcation(uploaded_file)
